...
from training.Classification.RandomForestClassification.Model.RandomForestModel import *
from sklearn.preprocessing import StandardScaler


class RandomForestClassification:

    def model_creation_random_classification(self):
        try:
            ...
            RandomForestModelClassification.create_save_pickle_random_forest(self, test_csv_path, classifier,y_test)
        except Exception as e:
            print(e)


obj = RandomForestClassification()
obj.model_creation_random_classification()
