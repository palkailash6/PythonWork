...
from training.Classification.LogisticClassification.Model.LogisticClassificationModel import *
from sklearn.preprocessing import StandardScaler

class LogisticClassfication:

    def model_creation_logistic(self):
          ...
          try:
                ...
                LogisticRegressionModel.create_save_pickle(self, test_csv_path, classifier,y_test)

          except Exception as e:
            print(e)


obj = LogisticClassfication()
obj.model_creation_logistic()
