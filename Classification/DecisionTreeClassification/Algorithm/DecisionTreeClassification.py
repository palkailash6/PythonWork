...
from training.Classification.DecisionTreeClassification.Model.DecisionTreeModel import *
from sklearn.preprocessing import StandardScaler


class DecisionTreeClassification:

    def model_creation_decision_classification(self):
        try:
...
obj.model_creation_decision_classification()
