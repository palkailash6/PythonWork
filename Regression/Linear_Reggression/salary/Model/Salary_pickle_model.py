...
class ControllerLinearSalary:

    def model_creation_linear_salary(self):
        ...
        simple.graph_plotting(regression,values.x_train, values.y_train,"Train data plot","Experience","Salary")
        test_obj = Test_data_Regression()
        test_linear_pkl_model = test_obj.get_test_accuraccy()

        # Test model prediction
        simple.graph_plotting(regression, values.x_test, values.y_test,"Test data plot","Experience","Salary")


obj = ControllerLinearSalary()
obj.model_creation_linear_salary()