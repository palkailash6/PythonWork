...
class DecisionTreeModel:
    ...
    def create_save_pickle(self, testcsv, regression_model,y_test):
        ...
        decision_tree_pkl_filename = '/home/admin1/PycharmProjects/bridgelabz/training/Classification/DecisionTreeClassification/Data/Decision_tree_Classification.pkl'
