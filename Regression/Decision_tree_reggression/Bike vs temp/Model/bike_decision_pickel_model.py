...
class ControllerDecisionBike:

    def model_creation_decision_bike(self):
        ...
        # Train data plotting
        obj.decision_plotting(values, "Train_Plot", regression, "Temprature", "Bike","Salary")
        ...
        # Train data plotting
        obj.decision_plotting(values, "Test_Plot", regression, "Temprature", "Bike","Salary")
...
obj = ControllerDecisionBike()
obj.model_creation_decision_bike()